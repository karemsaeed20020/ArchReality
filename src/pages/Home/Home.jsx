...
//             <div className="row">
//                 <div className="fe col-lg-6 order-lg-2 order-1 pt-5">
//                     <h2 className="main-text mb-5 pt-5 mt-5" style={{position: "relative" ,left: "70px"}}>Create New Account</h2>
//                     {error && <p className="text-danger">{error}</p>}
//                     <form onSubmit={handleSubmit} style={{position:"relative", left: "70px"}}>
...
//                     {/* Display image or visual */}
//                     <img src={Test222} alt="" className="img-fluid" style={{ height: "102vh", objectFit: "cover", position: "relative", left: "80px" }} />
//                 </div>
//             </div>
//         </div>
//     );
